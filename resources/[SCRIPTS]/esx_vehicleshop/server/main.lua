...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedPorru')
AddEventHandler('esx_vehicleshop:setVehicleOwnedPorru', function (vehicleProps,vehicleData)
...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedPorruPlayerId')
AddEventHandler('esx_vehicleshop:setVehicleOwnedPorruPlayerId', function (playerId, vehicleProps,vehicleData)
	local _source = source
...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedPorruSociety')
AddEventHandler('esx_vehicleshop:setVehicleOwnedPorruSociety', function (society, vehicleProps)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
