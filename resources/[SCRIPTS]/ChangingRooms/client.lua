...
AddEventHandler('esx_Cshop:hasEnteredMarker', function(zone)
	currentAction     = 'menu'
	currentActionMsg  = 'Pulsa ~INPUT_PICKUP~ abrir el apósito'
	currentActionData = {}
end)
...
ESX.ShowFloatingHelpNotification(('Pulse  ~INPUT_PICKUP~ para entrar a tu ~y~vestidor'), vector3(playerX, playerY, playerZ +0.8))
...
Citizen.CreateThread(function()
	for k,v in ipairs(Config.Room) do
		...
		AddTextComponentSubstringPlayerName('Vestuarios')
