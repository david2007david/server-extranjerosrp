...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('banda',0,'recruit','Recrue',20,'{}','{}'),
	('banda',1,'officer','Officier',40,'{}','{}'),
	('banda',2,'sergeant','Sergent',60,'{}','{}'),
	('banda',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('banda',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de banda',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de banda',110,1),
