...
INSERT INTO `jobs` (name, label) VALUES
	('aztekas','Aztekas Or Die')
;

INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('aztekas',0,'recruit','Recrue',20,'{}','{}'),
	('aztekas',1,'officer','Officier',40,'{}','{}'),
	('aztekas',2,'sergeant','Sergent',60,'{}','{}'),
	('aztekas',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('aztekas',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de aztekas',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de aztekas',110,1),
