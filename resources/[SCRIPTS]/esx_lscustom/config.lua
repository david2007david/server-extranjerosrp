...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -212.671, y = -1324.46, z = 30.27},
	...
	ls3 = {
		Pos   = { x = -337.458, y = -137.833, z = 38.39},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = -189.477, y = -1290.250, z = 31.54},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls5 = {
		Pos   = { x = -967.49, y = 1302.64, z = 282.48},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls6 = {
		Pos   = { x = -2575.258, y = 1874.315, z = 167.36},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {1.20, 1.40, 1.60, 2.70}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {1.06, 1.1, 1.2, 1.2}
	},
	modTransmission = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {1.65, 1.30, 1.61, 2.23, 3.86}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {6.77, 11.28, 13.00, 15.00, 18.00, 19.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
