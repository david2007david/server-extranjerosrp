...
local DISCORD_WEBHOOK = "https://discord.com/api/webhooks/855455951917547541/01RPLQiQyTiyRc0Jx_ynYONfeETVxN2h0TfCwQSNJoTc-Ooz24oO9pcDE6zpZyPHN02X"
local DISCORD_NAME = "ExtranjerosRP"
local STEAM_KEY = ""
local DISCORD_IMAGE = "https://i.imgur.com/vZOoZIy.png" -- default is FiveM logo
...
AddEventHandler('playerConnecting', function() 
    ...
    sendToDiscord("Server Log´s", "**" .. GetPlayerName(source) .. "** se ha conectado el servidor.", 65280)
end)
...
AddEventHandler('playerDropped', function(reason) 
  ...
  sendToDiscord("Server Log´s", "**" .. GetPlayerName(source) .. "** se ha desconectado del servidor. \n Reason: " .. reason, color)
end)
