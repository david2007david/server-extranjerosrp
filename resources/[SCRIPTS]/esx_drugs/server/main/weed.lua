...
RegisterServerEvent('esx_drugs:pickedUpCPorruannabis')
AddEventHandler('esx_drugs:pickedUpCPorruannabis', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_drugs:processCPorruannabis')
AddEventHandler('esx_drugs:processCPorruannabis', function()
