...
ESX.ShowFloatingHelpNotification((_U('atm_open')), vector3(playerX, playerY, playerZ +0.8))
...
RegisterNUICallback('deposit', function(data)
	TriggerServerEvent('bank:depPorruosit', tonumber(data.amount))
	TriggerServerEvent('bank:balance')
end)
...
RegisterNUICallback('withdrawl', function(data)
	TriggerServerEvent('bank:withdPorruraw', tonumber(data.amountw))
	TriggerServerEvent('bank:balance')
end)
...
RegisterNUICallback('transfer', function(data)
	TriggerServerEvent('bank:tranPorrusfer', data.to, data.amountt)
	TriggerServerEvent('bank:balance')
end)
