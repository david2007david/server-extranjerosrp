...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('mafia',0,'recruit','Recrue',20,'{}','{}'),
	('mafia',1,'officer','Officier',40,'{}','{}'),
	('mafia',2,'sergeant','Sergent',60,'{}','{}'),
	('mafia',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('mafia',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de mafia',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de mafia',110,1),
