...
RegisterServerEvent('esx_mafiajob:haPorrundcuff')
AddEventHandler('esx_mafiajob:haPorrundcuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

		TriggerClientEvent('esx_mafiajob:haPorrundcuff', target)
end)
