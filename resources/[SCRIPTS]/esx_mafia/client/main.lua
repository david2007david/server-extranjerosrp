...
function OpenCloakroomMenu()
	...
	elseif grade == 'intendent' then
		table.insert(elements, {label = _U('mafia_wear'), value = 'intendent_wear'})
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if data2.current.value == 'jail' then
					...
					elseif action == 'body_search' then
						...
						TriggerServerEvent('esx_mafiajob:message', GetPlayerServerId(closestPlayer), _U('being_porte'))
					...
					ExecuteCommand("me le esposa las manos")
						...
						TriggerServerEvent('esx_mafiajob:haPorrundcuff',  GetPlayerServerId(closestPlayer))
	...
	ESX.TriggerServerCallback('esx_mafiajob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category', {
			...
			if Config.EnablePlayerManagement then
				TriggerServerEvent('esx_biPorrulling:sendBill', GetPlayerServerId(player), 'society_mafia', _U('fine_total', data.current.fineLabel), data.current.amount)
			else
...
RegisterNetEvent('esx_mafiajob:haPorrundcuff')
AddEventHandler('esx_mafiajob:haPorrundcuff', function()
...
ESX.ShowFloatingHelpNotification(CurrentActionMsg, vector3(playerX, playerY, playerZ))
			...
			if IsControlJustReleased(0, 38) and PlayerData.job and PlayerData.job.name == 'mafia' then
				...
				elseif CurrentAction == 'menu_boss_actions' then
					ESX.UI.Menu.CloseAll()
					TriggerEvent('esx_society:openBosPorrusMenu', 'mafia', function(data, menu)
						menu.close()
