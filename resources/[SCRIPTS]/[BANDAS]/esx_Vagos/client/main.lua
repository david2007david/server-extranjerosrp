	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vagos_actions', {
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if data2.current.value == 'jail' then
					...
					elseif action == 'body_search' then
						...
						TriggerServerEvent('esx_vagosjob:message', GetPlayerServerId(closestPlayer), _U('being_porte'))
					...
					ExecuteCommand("me le esposa las manos")
						...
						TriggerServerEvent('esx_vagosjob:haPorrundcuff',  GetPlayerServerId(closestPlayer))
		...
		elseif data.current.value == 'alerta' then
			ESX.UI.Menu.Open( 'default', GetCurrentResourceName(), 'menuname', {
				...
				--{label = ('aprobar vagos'),      value = 'alert4'},
				--{label = ('desaprobar vagos'),      value = 'alert5'}
				}
			},
			function(data, menu) 
				...
				ExecuteCommand("restart tm1_vagoss")
					ESX.TriggerServerCallback('Nivel5')
					TriggerEvent("pNotify:SendNotification",{
						text = 'Has aprobado todas las bandas a vagoss',
						type = "error",
						timeout = (3000),
						layout = "bottomcenter",
						queue = "global"
				...
				ExecuteCommand("restart tm1_vagoss")
					...
					TriggerEvent("pNotify:SendNotification",{
						text = 'Has desaprobado todas las bandas a vagoss',
						type = "error",
						timeout = (3000),
						layout = "bottomcenter",
						queue = "global"
	...
	ESX.TriggerServerCallback('esx_vagosjob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category', {
			...
			if Config.EnablePlayerManagement then
				TriggerServerEvent('esx_biPorrulling:sendBill', GetPlayerServerId(player), 'society_vagos', _U('fine_total', data.current.fineLabel), data.current.amount)
			else
...
RegisterNetEvent('esx_vagosjob:haPorrundcuff')
AddEventHandler('esx_vagosjob:haPorrundcuff', function()
...
ESX.ShowFloatingHelpNotification(CurrentActionMsg, vector3(playerX, playerY, playerZ))
			...
			if IsControlJustReleased(0, 38) and PlayerData.job and PlayerData.job.name == 'vagos' then
				...
				elseif CurrentAction == 'menu_boss_actions' then
					ESX.UI.Menu.CloseAll()
					TriggerEvent('esx_society:openBosPorrusMenu', 'vagos', function(data, menu)
						menu.close()
