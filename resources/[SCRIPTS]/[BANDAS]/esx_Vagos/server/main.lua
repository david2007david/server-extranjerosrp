...
RegisterServerEvent('esx_vagosjob:haPorrundcuff')
AddEventHandler('esx_vagosjob:haPorrundcuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

		TriggerClientEvent('esx_vagosjob:haPorrundcuff', target)
end)
