...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	...
	('vagos',1,'officer','Officier',40,'{}','{}'),
	('vagos',2,'sergeant','Sergent',60,'{}','{}'),
	('vagos',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('vagos',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de vagos',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de vagos',110,1),
