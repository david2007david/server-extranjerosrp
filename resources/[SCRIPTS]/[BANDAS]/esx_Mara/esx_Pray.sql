...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('mara',0,'recruit','Recrue',20,'{}','{}'),
	('mara',1,'officer','Officier',40,'{}','{}'),
	('mara',2,'sergeant','Sergent',60,'{}','{}'),
	('mara',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('mara',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de mara',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de mara',110,1),
