...
INSERT INTO `jobs` (name, label) VALUES
	('Midnightclub','Midnightclub Or Die')
;

INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('Midnightclub',0,'recruit','Recrue',20,'{}','{}'),
	('Midnightclub',1,'officer','Officier',40,'{}','{}'),
	('Midnightclub',2,'sergeant','Sergent',60,'{}','{}'),
	('Midnightclub',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('Midnightclub',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de Midnightclub',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de Midnightclub',110,1),
