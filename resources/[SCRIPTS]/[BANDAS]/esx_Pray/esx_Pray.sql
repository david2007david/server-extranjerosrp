...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('pray',0,'recruit','Recrue',20,'{}','{}'),
	('pray',1,'officer','Officier',40,'{}','{}'),
	('pray',2,'sergeant','Sergent',60,'{}','{}'),
	('pray',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('pray',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de pray',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de pray',110,1),
