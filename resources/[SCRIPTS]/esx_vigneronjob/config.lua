...
Config.Zones = {
	...
	TraitementJus = {
		...
		Size  = {x = 3.5, y = 3.5, z = 2.0},
		Color = {r = 136, g = 243, b = 216},
		Name  = "Procesamiento de jugo de uva",
		Type  = 1
	},
	
	SellFarm = {
		Pos   = {x = -158.737, y = -54.651, z = 54.396},
