...
RegisterServerEvent('esx_policejob:haPorrundcuff')
AddEventHandler('esx_policejob:haPorrundcuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

		TriggerClientEvent('esx_policejob:haPorrundcuff', target)
end)
...
RegisterServerEvent('plr_comidacnp:getJob')
AddEventHandler('plr_comidacnp:getJob',function()
	local source = source
	local xPlayers = ESX.GetPlayers()
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		if xPlayers[i] == source then
			TriggerClientEvent('plr_comidacnp:setJob',xPlayers[i],xPlayer.job.name)
		end
	end
end)

RegisterServerEvent('plr_comidacnp:buyItem')
AddEventHandler('plr_comidacnp:buyItem', function(itemName, price)
	...
	if money >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, "Has comprado un " .. ESX.GetItemLabel(itemName))
