      ...
      if data.current.value == 'withdraw_society_money' then
        ...
        ESX.UI.Menu.Open(
          ...
          function(data, menu)
			...
			ExecuteCommand("report saca dinero de la sociedad")
...
AddEventHandler('esx_society:openBosPorrusMenu', function(society, close, options)
