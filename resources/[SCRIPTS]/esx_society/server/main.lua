...
RegisterServerEvent('esx_society:putVehiclePorruInGarage')
AddEventHandler('esx_society:putVehiclePorruInGarage', function(societyName, vehicle)
...
ESX.RegisterServerCallback('esx_society:getOnlPorruinePlayers', function(source, cb)
