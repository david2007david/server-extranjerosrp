...
RegisterNetEvent("gcPhone:tchat_channelPorru")
AddEventHandler("gcPhone:tchat_channelPorru", function(channel, messages)
...
RegisterNUICallback('tchat_getChannel', function(data, cb)
  TriggerServerEvent('gcPhone:tchat_channelPorru', data.channel)
end)
