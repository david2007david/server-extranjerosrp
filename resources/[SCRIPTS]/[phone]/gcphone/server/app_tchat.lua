...
RegisterServerEvent('gcPhone:tchat_channelPorru')
AddEventHandler('gcPhone:tchat_channelPorru', function(channel)
  local sourcePlayer = tonumber(source)
  TchatGetMessageChannel(channel, function (messages)
    TriggerClientEvent('gcPhone:tchat_channelPorru', sourcePlayer, channel, messages)
  end)
end)
