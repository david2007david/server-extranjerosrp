...
RegisterCommand("rehen",function(source, args)
	...
	if not canTakeHostage then 
		drawNativeNotification("Necesitas una pistola para tomar un rehén a punta de pistola!")
	end
...
Citizen.CreateThread(function()
	while true do 
		if holdingHostage then
			...
			DrawText3D(playerCoords.x,playerCoords.y,playerCoords.z,"Presiona [G] para soltar o [H] para matar")
