...
Config.Strings = {
	...
	EToRefuel = "Presiona ~g~E ~w~para repostar gasolina",
	JerryCanEmpty = "el bidon está vacío",
	FullTank = "El depósito esta lleno",
	PurchaseJerryCan = "Pulse ~g~E ~w~comprar un bidón por ~g~€" .. Config.JerryCanCost,
	CancelFuelingPump = "Presiona ~g~E ~w~para cancelar el repostado",
	CancelFuelingJerryCan = "Pulse ~g~E ~w~para cancelar el repostaje",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Pulse ~g~E ~w~ para rellenar el bidón para ",
	NotEnoughCashJerryCan = "No hay suficiente dinero en efectivo para recargar bidones",
	JerryCanFull = "Bidon esta lleno",
	TotalCost = "Precio",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Pulse ~g~E ~w~agarrar un bidón"
	Config.Strings.RefillJerryCan = "Pulse ~g~E ~w~ para rellenar el bidón"
end
