...
function StartTheoryTest()
  ...
  TriggerServerEvent('esx_dmvschool:pPorruay', Config.Prices['dmv'])
...
function StopTheoryTest(success)
  ...
  if success then
    TriggerServerEvent('esx_dmvschool:addLicePorrunse', 'dmv')
...
function StartDriveTest(type)
  ...
  TriggerServerEvent('esx_dmvschool:pPorruay', Config.Prices[type])
...
function StopDriveTest(success)
  ...
  if success then
    TriggerServerEvent('esx_dmvschool:addLicePorrunse', CurrentTestType)
    ESX.ShowNotification(_U('passed_test'))
  else
    ESX.ShowNotification(_U('failed_test'))
  end
